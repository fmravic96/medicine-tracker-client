...
export const IllustrationIcon = (props: IconProps) => {
  return (
    <Icon width="100%" viewBox="0 0 1105.04 782.74" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        ...
        <linearGradient
          ...
          x2="940.67"
          y2="263.72"
          xlinkHref="#ac3cc305-f6db-42f4-bbbd-32121ee27a74"
        />
      </defs>
      <ellipse cx="367.38" cy="766.65" rx="97.44" ry="15.65" fill="#00b0ff" opacity="0.1" />
      <ellipse cx="897.05" cy="767.09" rx="121.59" ry="15.65" fill="#00b0ff" opacity="0.1" />
      <path
      ...
      <polygon
        ...
        opacity="0.1"
      />
      <rect x="139.57" y="338.19" width="76.3" height="138.33" fill="#00b0ff" opacity="0.1" />
      <path
        ...
        opacity="0.1"
      />
      <rect x="629.96" y="194.56" width="62.92" height="139.35" fill="#00b0ff" opacity="0.1" />
      <polygon
      ...
      <path
        ...
        opacity="0.1"
      />
      <rect x="659.18" y="233.3" width="33.71" height="43.69" fill="#00b0ff" opacity="0.1" />
      <rect x="659.18" y="323.86" width="33.71" height="10.06" fill="#00b0ff" opacity="0.1" />
      <rect x="659.18" y="338.19" width="33.71" height="29.35" fill="#00b0ff" opacity="0.1" />
      <rect x="659.18" y="414.42" width="33.71" height="43.69" fill="#00b0ff" opacity="0.1" />
      <rect x="659.18" y="504.98" width="33.71" height="43.69" fill="#00b0ff" opacity="0.1" />
      <path d="M740.12,687.7c.34,0,.67,0,1,.06l-1,0v10.15h-33.7V654.17h33.7Z" transform="translate(-47.24 -58.63)" fill="#00b0ff" opacity="0.1" />
      <path d="M740.12,744.71v33.75q-16.9-1.43-33.7-3.89V744.71Z" transform="translate(-47.24 -58.63)" fill="#00b0ff" opacity="0.1" />
      <rect x="380.58" y="473.32" width="144.47" height="3.21" fill="#00b0ff" opacity="0.1" />
      <rect x="380.58" y="480.8" width="144.47" height="12.3" fill="#00b0ff" opacity="0.1" />
      <rect x="380.58" y="533.42" width="144.47" height="19.78" fill="#00b0ff" opacity="0.1" />
      <path
        ...
        opacity="0.1"
      />
      <path d="M572.28,712.24V732H560.35q-20.11-9.07-39.43-19.79Z" transform="translate(-47.24 -58.63)" fill="#00b0ff" opacity="0.1" />
      <rect x="775.83" y="351.6" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="160.05" y="219.09" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="160.05" y="285.15" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="160.05" y="351.21" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="160.05" y="417.26" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="160.05" y="483.32" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="160.05" y="549.38" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="884.4" y="351.6" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="775.83" y="421.75" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="884.4" y="421.75" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="775.83" y="491.89" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="884.4" y="491.89" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="775.83" y="562.04" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="884.4" y="562.04" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="775.83" y="632.19" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <rect x="884.4" y="632.19" width="28.44" height="28.44" fill="#00b0ff" opacity="0.1" />
      <polygon points="775.83 720.67 775.83 702.33 804.26 702.33 804.26 718.06 775.83 720.67" fill="#00b0ff" opacity="0.1" />
      <path
      ...
      <ellipse cx="132.73" cy="744.94" rx="97.44" ry="15.65" fill="#00b0ff" opacity="0.1" />
